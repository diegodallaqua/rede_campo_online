...
class PendingEventMedia {
  final XFile file;
  String name;

  PendingEventMedia({required this.file, this.name = ''});
}

class EventMediaUploadField extends StatefulWidget {
  const EventMediaUploadField({
    super.key,
  ...
  final List<EventMedia> existingItems;
  final List<PendingEventMedia> items;
  ...
  @override
  State<EventMediaUploadField> createState() => _EventMediaUploadFieldState();
}

class _EventMediaUploadFieldState extends State<EventMediaUploadField> {
  final _picker = ImagePicker();
  final Map<PendingEventMedia, TextEditingController> _controllers = {};
  final Map<PendingEventMedia, Future<Uint8List>> _thumbnails = {};

  TextEditingController _controllerFor(PendingEventMedia item) {
  ...
  Future<Uint8List> _thumbnailFor(PendingEventMedia item) {
    return _thumbnails.putIfAbsent(item, () => item.file.readAsBytes());
  }

  @override
  void didUpdateWidget(EventMediaUploadField oldWidget) {
