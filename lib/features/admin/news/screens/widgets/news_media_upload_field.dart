...
class PendingNewsMedia {
  final XFile file;
  String name;

  PendingNewsMedia({required this.file, this.name = ''});
}

class NewsMediaUploadField extends StatefulWidget {
  const NewsMediaUploadField({
    super.key,
  ...
  final List<NewsMedia> existingItems;
  final List<PendingNewsMedia> items;
  ...
  @override
  State<NewsMediaUploadField> createState() => _NewsMediaUploadFieldState();
}

class _NewsMediaUploadFieldState extends State<NewsMediaUploadField> {
  final _picker = ImagePicker();
  final Map<PendingNewsMedia, TextEditingController> _controllers = {};
  final Map<PendingNewsMedia, Future<Uint8List>> _thumbnails = {};

  TextEditingController _controllerFor(PendingNewsMedia item) {
  ...
  Future<Uint8List> _thumbnailFor(PendingNewsMedia item) {
    return _thumbnails.putIfAbsent(item, () => item.file.readAsBytes());
  }

  @override
  void didUpdateWidget(NewsMediaUploadField oldWidget) {
