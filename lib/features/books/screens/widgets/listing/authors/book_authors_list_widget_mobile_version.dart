...
class BookAuthorsListWidgetMobileVersion extends StatefulWidget {
  ...
  const BookAuthorsListWidgetMobileVersion({
    super.key,
    required this.contributors,
  });

  @override
  State<BookAuthorsListWidgetMobileVersion> createState() =>
      _BookAuthorsListWidgetMobileVersionState();
}

class _BookAuthorsListWidgetMobileVersionState
    extends State<BookAuthorsListWidgetMobileVersion> {
  ...
  void _scrollLeft() {
    final target = (_scrollController.offset -
            BookAuthorsListWidgetMobileVersion._cardWidth -
            BookAuthorsListWidgetMobileVersion._gap)
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final int visibleCount =
            ((availableWidth + BookAuthorsListWidgetMobileVersion._gap) /
                    (BookAuthorsListWidgetMobileVersion._cardWidth +
                        BookAuthorsListWidgetMobileVersion._gap))
                .floor()
        ...
        return Row(
          children: [
            ...
            Expanded(
              child: SizedBox(
                height: BookAuthorsListWidgetMobileVersion._cardHeight,
                child: ListView.separated(
                  ...
                  separatorBuilder: (_, __) => const SizedBox(
                    width: BookAuthorsListWidgetMobileVersion._gap,
                  ),
