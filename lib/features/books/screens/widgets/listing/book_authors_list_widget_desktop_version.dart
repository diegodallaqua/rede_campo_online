...
class BookAuthorsListWidgetDesktopVersion extends StatefulWidget {
  ...
  const BookAuthorsListWidgetDesktopVersion({
    super.key,
    required this.contributors,
  });

  @override
  State<BookAuthorsListWidgetDesktopVersion> createState() =>
      _BookAuthorsListWidgetDesktopVersionState();
}

class _BookAuthorsListWidgetDesktopVersionState
    extends State<BookAuthorsListWidgetDesktopVersion> {
  ...
  void _scrollLeft() {
    final target = (_scrollController.offset -
            BookAuthorsListWidgetDesktopVersion._cardWidth -
            BookAuthorsListWidgetDesktopVersion._gap)
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final int visibleCount =
            ((availableWidth + BookAuthorsListWidgetDesktopVersion._gap) /
                    (BookAuthorsListWidgetDesktopVersion._cardWidth +
                        BookAuthorsListWidgetDesktopVersion._gap))
                .floor()
        ...
        return Row(
          children: [
            ...
            Expanded(
              child: SizedBox(
                height: BookAuthorsListWidgetDesktopVersion._cardHeight,
                child: ListView.separated(
                  ...
                  separatorBuilder: (_, __) => const SizedBox(
                    width: BookAuthorsListWidgetDesktopVersion._gap,
                  ),
