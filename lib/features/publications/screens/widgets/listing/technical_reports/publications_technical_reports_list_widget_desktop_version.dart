...
class PublicationsTechnicalReportsListWidgetDesktopVersion
  ...
  @override
  State<PublicationsTechnicalReportsListWidgetDesktopVersion> createState() =>
      _PublicationsTechnicalReportsListWidgetDesktopVersionState();
}

class _PublicationsTechnicalReportsListWidgetDesktopVersionState
    extends State<PublicationsTechnicalReportsListWidgetDesktopVersion> {
    ...
    return Padding(
      ...
      child: GridView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return TechnicalReportTileDesktopVersion(
