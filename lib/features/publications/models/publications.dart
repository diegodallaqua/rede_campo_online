...
class Publications {
  ...
  @override
  String toString() {
    return 'Publications{id: $id, title: $title, abstract: $abstract, publication_date: $publication_date, doi: $doi, research_areas: $research_areas}';
  }
  ...
  factory Publications.fromMap(Map<String, dynamic> map) {
    return Publications(
      ...
      publication_date: map['publication_date'] != null ? DateTime.parse(map['publication_date']) : null,
