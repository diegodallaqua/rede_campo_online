...
class TechnicalReportHeaderSectionDesktopVersion extends StatelessWidget {
  final TechnicalReports technicalReport;

  const TechnicalReportHeaderSectionDesktopVersion({
    super.key,
  ...
  Widget build(BuildContext context) {
    final title = technicalReport.publication?.title ?? '—';
    final doi = technicalReport.publication?.doi ?? '';
    final areas = technicalReport.publication?.research_areas ?? [];
          ...
          child: Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                Expanded(
                  flex: 3,
                  child: _TechnicalReportMetadataCard(technicalReport: technicalReport),
                ),
              ],
            ),
          ),
...
class _TechnicalReportMetadataCard extends StatelessWidget {
  final TechnicalReports technicalReport;

  const _TechnicalReportMetadataCard({required this.technicalReport});

  @override
  Widget build(BuildContext context) {
    final date = technicalReport.publication?.publication_date;
