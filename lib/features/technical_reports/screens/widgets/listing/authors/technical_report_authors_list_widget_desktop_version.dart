...
class TechnicalReportAuthorsListWidgetDesktopVersion extends StatefulWidget {
  ...
  const TechnicalReportAuthorsListWidgetDesktopVersion({
    super.key,
    required this.contributors,
  });

  @override
  State<TechnicalReportAuthorsListWidgetDesktopVersion> createState() =>
      _TechnicalReportAuthorsListWidgetDesktopVersionState();
}

class _TechnicalReportAuthorsListWidgetDesktopVersionState
    extends State<TechnicalReportAuthorsListWidgetDesktopVersion> {
  ...
  void _scrollLeft() {
    final target = (_scrollController.offset -
            TechnicalReportAuthorsListWidgetDesktopVersion._cardWidth -
            TechnicalReportAuthorsListWidgetDesktopVersion._gap)
  ...
  Widget build(BuildContext context) {
    if (widget.contributors.isEmpty) {
      return const ListEmptyState(
        message: 'Nenhum autor vinculado a este relatório.',
        ...
        return Row(
          children: [
            ...
            Expanded(
              child: SizedBox(
                height:
                    TechnicalReportAuthorsListWidgetDesktopVersion._cardHeight,
                child: ListView.separated(
                  ...
                  separatorBuilder: (_, __) => const SizedBox(
                    width: TechnicalReportAuthorsListWidgetDesktopVersion._gap,
                  ),
