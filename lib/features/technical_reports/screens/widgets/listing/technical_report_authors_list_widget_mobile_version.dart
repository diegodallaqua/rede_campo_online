...
class TechnicalReportAuthorsListWidgetMobileVersion extends StatefulWidget {
  ...
  const TechnicalReportAuthorsListWidgetMobileVersion({
    super.key,
    required this.contributors,
  });

  @override
  State<TechnicalReportAuthorsListWidgetMobileVersion> createState() =>
      _TechnicalReportAuthorsListWidgetMobileVersionState();
}

class _TechnicalReportAuthorsListWidgetMobileVersionState
    extends State<TechnicalReportAuthorsListWidgetMobileVersion> {
  ...
  void _scrollLeft() {
    final target = (_scrollController.offset -
            TechnicalReportAuthorsListWidgetMobileVersion._cardWidth -
            TechnicalReportAuthorsListWidgetMobileVersion._gap)
      ...
      builder: (context, constraints) {
        ...
        return Row(
          children: [
            ...
            Expanded(
              child: SizedBox(
                height: TechnicalReportAuthorsListWidgetMobileVersion._cardHeight,
                child: ListView.separated(
                  ...
                  separatorBuilder: (_, __) => const SizedBox(
                    width: TechnicalReportAuthorsListWidgetMobileVersion._gap,
                  ),
