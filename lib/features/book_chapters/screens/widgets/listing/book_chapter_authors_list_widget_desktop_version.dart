...
class BookChapterAuthorsListWidgetDesktopVersion extends StatefulWidget {
  ...
  const BookChapterAuthorsListWidgetDesktopVersion({
    super.key,
    required this.contributors,
  });

  @override
  State<BookChapterAuthorsListWidgetDesktopVersion> createState() =>
      _BookChapterAuthorsListWidgetDesktopVersionState();
}

class _BookChapterAuthorsListWidgetDesktopVersionState
    extends State<BookChapterAuthorsListWidgetDesktopVersion> {
  ...
  void _scrollLeft() {
    final target = (_scrollController.offset -
            BookChapterAuthorsListWidgetDesktopVersion._cardWidth -
            BookChapterAuthorsListWidgetDesktopVersion._gap)
  ...
  Widget build(BuildContext context) {
    if (widget.contributors.isEmpty) {
      return const ListEmptyState(
        message: 'Nenhum autor vinculado a este capítulo.',
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final int visibleCount =
            ((availableWidth + BookChapterAuthorsListWidgetDesktopVersion._gap) /
                    (BookChapterAuthorsListWidgetDesktopVersion._cardWidth +
                        BookChapterAuthorsListWidgetDesktopVersion._gap))
                .floor()
        ...
        return Row(
          children: [
            ...
            Expanded(
              child: SizedBox(
                height: BookChapterAuthorsListWidgetDesktopVersion._cardHeight,
                child: ListView.separated(
                  ...
                  separatorBuilder: (_, __) => const SizedBox(
                    width: BookChapterAuthorsListWidgetDesktopVersion._gap,
                  ),
