...
class BookChapterAuthorsListWidgetMobileVersion extends StatefulWidget {
  ...
  const BookChapterAuthorsListWidgetMobileVersion({
    super.key,
    required this.contributors,
  });

  @override
  State<BookChapterAuthorsListWidgetMobileVersion> createState() =>
      _BookChapterAuthorsListWidgetMobileVersionState();
}

class _BookChapterAuthorsListWidgetMobileVersionState
    extends State<BookChapterAuthorsListWidgetMobileVersion> {
  ...
  void _scrollLeft() {
    final target = (_scrollController.offset -
            BookChapterAuthorsListWidgetMobileVersion._cardWidth -
            BookChapterAuthorsListWidgetMobileVersion._gap)
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final int visibleCount =
            ((availableWidth + BookChapterAuthorsListWidgetMobileVersion._gap) /
                    (BookChapterAuthorsListWidgetMobileVersion._cardWidth +
                        BookChapterAuthorsListWidgetMobileVersion._gap))
                .floor()
        ...
        return Row(
          children: [
            ...
            Expanded(
              child: SizedBox(
                height: BookChapterAuthorsListWidgetMobileVersion._cardHeight,
                child: ListView.separated(
                  ...
                  separatorBuilder: (_, __) => const SizedBox(
                    width: BookChapterAuthorsListWidgetMobileVersion._gap,
                  ),
