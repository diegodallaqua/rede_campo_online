...
class ThesisAuthorsListWidgetMobileVersion extends StatefulWidget {
  ...
  const ThesisAuthorsListWidgetMobileVersion({
    super.key,
    required this.contributors,
  });

  @override
  State<ThesisAuthorsListWidgetMobileVersion> createState() =>
      _ThesisAuthorsListWidgetMobileVersionState();
}

class _ThesisAuthorsListWidgetMobileVersionState
    extends State<ThesisAuthorsListWidgetMobileVersion> {
  ...
  void _scrollLeft() {
    final target = (_scrollController.offset -
            ThesisAuthorsListWidgetMobileVersion._cardWidth -
            ThesisAuthorsListWidgetMobileVersion._gap)
      ...
      builder: (context, constraints) {
        ...
        return Row(
          children: [
            ...
            Expanded(
              child: SizedBox(
                height: ThesisAuthorsListWidgetMobileVersion._cardHeight,
                child: ListView.separated(
                  ...
                  separatorBuilder: (_, __) => const SizedBox(
                    width: ThesisAuthorsListWidgetMobileVersion._gap,
                  ),
