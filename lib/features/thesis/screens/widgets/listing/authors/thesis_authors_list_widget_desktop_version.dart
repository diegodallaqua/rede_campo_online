...
class ThesisAuthorsListWidgetDesktopVersion extends StatefulWidget {
  ...
  const ThesisAuthorsListWidgetDesktopVersion({
    super.key,
    required this.contributors,
  });

  @override
  State<ThesisAuthorsListWidgetDesktopVersion> createState() =>
      _ThesisAuthorsListWidgetDesktopVersionState();
}

class _ThesisAuthorsListWidgetDesktopVersionState
    extends State<ThesisAuthorsListWidgetDesktopVersion> {
  ...
  void _scrollLeft() {
    final target = (_scrollController.offset -
            ThesisAuthorsListWidgetDesktopVersion._cardWidth -
            ThesisAuthorsListWidgetDesktopVersion._gap)
  ...
  Widget build(BuildContext context) {
    if (widget.contributors.isEmpty) {
      return const ListEmptyState(
        message: 'Nenhum autor vinculado a esta dissertação.',
      ...
      builder: (context, constraints) {
        ...
        return Row(
          children: [
            ...
            Expanded(
              child: SizedBox(
                height: ThesisAuthorsListWidgetDesktopVersion._cardHeight,
                child: ListView.separated(
                  ...
                  separatorBuilder: (_, __) => const SizedBox(
                    width: ThesisAuthorsListWidgetDesktopVersion._gap,
                  ),
