...
class ContributorsCarousel extends StatefulWidget {
  ...
  @override
  State<ContributorsCarousel> createState() => _ContributorsCarouselState();
}

class _ContributorsCarouselState extends State<ContributorsCarousel> {
  ...
  void _scrollLeft() {
    final target = (_scrollController.offset -
            ContributorsCarousel._cardWidth -
            ContributorsCarousel._gap)
  ...
  Widget _buildList(List<Contributors> contributors) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final int visibleCount = ((availableWidth + ContributorsCarousel._gap) /
                (ContributorsCarousel._cardWidth + ContributorsCarousel._gap))
            .floor()
        ...
        return Row(
          children: [
            ...
            Expanded(
              child: SizedBox(
                height: ContributorsCarousel._cardHeight,
                child: ListView.separated(
                  ...
                  separatorBuilder: (_, __) => const SizedBox(
                    width: ContributorsCarousel._gap,
                  ),
